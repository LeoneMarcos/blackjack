...
## Composition
A 1200px content frame contains a compact brand/score/help header, a mode toolbar, a continuous playing surface and a secondary keyboard footer. Two equal player regions share a table with a fine center divider rather than independent colorful containers. Scores sit beside player identities; cards occupy the visual center. Mobile below 640px stacks the hands; below 1024px the header wraps. Safe margins are 24px desktop and 16px mobile.
